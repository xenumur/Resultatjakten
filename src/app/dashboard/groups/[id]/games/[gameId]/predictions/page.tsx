  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-8 pb-32">
      ...
      <form action={bindedSaveAll} className="space-y-12">
        ...
        {/* Flytande spara-knapp för mobilen (uppe till höger, bredvid logout) */}
        ...
        <div className="hidden md:flex fixed bottom-0 left-0 right-0 p-6 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-t border-zinc-200 dark:border-zinc-800 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-50 justify-center">
          <button type="submit" className="w-full max-w-sm flex items-center justify-center gap-3 bg-indigo-600 text-white py-4 rounded-2xl font-black text-lg hover:bg-indigo-700 active:scale-[0.98] transition-all shadow-xl shadow-indigo-600/20">
            <Save className="w-6 h-6" />
            Spara Alla Tips
          </button>
        </div>
