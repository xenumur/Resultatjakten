...
import BonusAdminClient from './BonusAdminClient'
...
export default async function BonusAdminPage({
  ...
  if (member?.role !== 'admin') redirect(`/dashboard/groups/${groupId}`)
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 md:px-10 md:py-12 space-y-12">
      ...
      <BonusAdminClient groupId={groupId} initialQuestions={questions || []} />
    </div>
  )
}
